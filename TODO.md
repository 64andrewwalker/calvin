...
## Phase 7.5: Migration Commands (from API versioning plan) ✅ COMPLETE
...
- [x] Example `.promptpack/` ✅ (36 workflows included)

---

## Phase 9: Distribution ✅ COMPLETE
...
## Scope Policy Consistency 🔴 IN PROGRESS
...
- [x] **SC-6**: Add `--cleanup` flag to `deploy` ✅ 2025-12-19
  - [x] CLI flag added
...
| 7.5: Migrate | ✅ Complete | Format/adapter migration |
| 8: Testing | ✅ Complete | 164 tests passing, golden tests, docs |
