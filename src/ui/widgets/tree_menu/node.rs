//! TreeNode data structure and selection logic.
//!
//! This module contains the core data structures for representing
//! a hierarchical tree with selection states.
...
mod tests {
    ...
    fn node_deep_nesting_selection_propagates() {
        ...
        assert_eq!(root.children[0].state, SelectionState::Selected);
        assert_eq!(root.children[0].children[0].state, SelectionState::Selected);
        assert_eq!(
