...
mod tests {
    ...
    fn test_orphan_is_safe_to_delete() {
        let orphan =
            OrphanFile::from_key("home:~/.claude/commands/test.md").with_status(true, true);
        assert!(orphan.is_safe_to_delete());

        let orphan_no_sig =
            OrphanFile::from_key("home:~/.claude/commands/test.md").with_status(true, false);
        assert!(!orphan_no_sig.is_safe_to_delete());

        let orphan_not_exists =
            OrphanFile::from_key("home:~/.claude/commands/test.md").with_status(false, true);
