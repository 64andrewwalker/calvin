...
use crate::sync::lockfile::{lockfile_key, LockfileNamespace, Lockfile};
...
pub fn check_orphan_status<FS: crate::fs::FileSystem + ?Sized>(
    orphan: &mut OrphanFile,
    fs: &FS,
) {
...
mod tests {
    ...
    fn test_detect_orphans_finds_removed_files() {
        ...
        let outputs = vec![
            OutputFile::new(PathBuf::from("~/.claude/commands/current.md"), "content"),
        ];
