...
"#,
    ...
    fn clean_selected_keys_only_deletes_selected() {
        ...
        // Create lockfile with both entries
        let abs_path1 = file1.to_string_lossy();
        let abs_path2 = file2.to_string_lossy();
        let key2 = format!("project:{}", abs_path2);
...
hash = "{}"
"#,
                abs_path1, hash1, abs_path2, hash2
            ),
        )
        .unwrap();
