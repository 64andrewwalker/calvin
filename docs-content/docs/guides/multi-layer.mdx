...
- [Scope Guide](/guides/scope-guide) — Understanding deployment scopes
- [Skills](/guides/skills) — Directory-based capabilities in multi-layer context
- [Configuration](/guides/configuration) — Layer configuration options
